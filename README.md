...
It is a web application that allows you to save notes server side.
...
you would click get started then add a title and a description for the note and then hit the save button.
